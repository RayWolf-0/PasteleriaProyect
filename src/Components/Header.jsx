    ...
    <header>
      <nav className="navbar navbar-expand-lg navbar-dark pastel-navbar">
        <div className="container-fluid">
          ...
          <a className="navbar-brand ms-3">Pastelería Mil Sabores</a>
          ...
          <div className="collapse navbar-collapse" id="header">
            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li className="nav-item dropdown">
                ...
                <ul className="dropdown-menu">
                  <li><Link className="dropdown-item" to="/menu/pasteles">Pasteles</Link></li>
                  <li><Link className="dropdown-item" to="/menu/galletas">Galletas</Link></li>
                  <li><Link className="dropdown-item" to="/menu/dulces">Dulces</Link></li>
                </ul>
              </li>
              ...
              {user?.role === "cliente" && (
                <>
                  ...
                  <li className="nav-item">
                    <Link to="/carrito" className="nav-link text-decoration-none">Carrito</Link>
                  </li>

                  <li className="nav-item">
                    <Link to="/pedido" className="nav-link text-decoration-none">Pedido</Link>
                  </li>
                </>
              )}
              ...
              {user?.role === "admin" && (
                <li className="nav-item">
                  <Link to="/administrador" className="nav-link text-decoration-none">
                    Administrador
                  </Link>
                </li>
              )}
            ...
            <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
              ...
              {isAuthenticated && (
                <li className="nav-item">
                  <button className="button" id="txtsalir" onClick={manejarLogout}>
                    Salir
                  </button>
                </li>
              )}
